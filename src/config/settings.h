...
#define SETTING_COUNT (SETTING_STATIC_COUNT + SETTING_WIFI_FOLDER_COUNT + SETTING_SERVO_FOLDER_COUNT + SETTING_SCREEN_FOLDER_COUNT + SETTING_DIAGNOSTICS_FOLDER_COUNT + SETTING_DEVELOPER_FOLDER_COUNT)
