...
#define SETTING_TRACKER_FOLDER_COUNT 5
#define SETTING_ESTIMATE_FOLDER_COUNT 2
#define SETTING_HOME_FOLDER_COUNT 6
#if defined(USE_WIFI)
...
#define SETTING_COUNT (SETTING_STATIC_COUNT + SETTING_TRACKER_FOLDER_COUNT + SETTING_ESTIMATE_FOLDER_COUNT + SETTING_HOME_FOLDER_COUNT + SETTING_MONITOR_FOLDER_COUNT + SETTING_BATTERY_FOLDER_COUNT + SETTING_POWER_FOLDER_COUNT + SETTING_WIFI_FOLDER_COUNT + SETTING_PORT_FOLDER_COUNT + SETTING_PORT_UART1_FOLDER_COUNT + SETTING_PORT_UART2_FOLDER_COUNT + SETTING_SERVO_FOLDER_COUNT + SETTING_SERVO_PAN_FOLDER_COUNT + SETTING_SERVO_TILT_FOLDER_COUNT + SETTING_EASE_FOLDER_COUNT + SETTING_SCREEN_FOLDER_COUNT + SETTING_BEEPER_FOLDER_COUNT + SETTING_DIAGNOSTICS_FOLDER_COUNT + SETTING_DEVELOPER_FOLDER_COUNT)
...
#define SETTING_KEY_TRACKER_HOME SETTING_KEY_TRACKER_PREFIX "h"
