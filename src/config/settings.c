...
static const setting_t settings[] = {
    ...
    U16_SETTING(SETTING_KEY_SERVO_TILT_MAX_DEGREE, "Max Degree", SETTING_FLAG_VALUE, FOLDER_ID_TILT, 180, 360, DEFAULT_SERVO_MAX_DEGREE),
    U16_SETTING(SETTING_KEY_SERVO_TILT_MIN_DEGREE, "Min Degree", SETTING_FLAG_VALUE, FOLDER_ID_TILT, 0, 360, DEFAULT_SERVO_MIN_DEGREE),
    ...
    U16_SETTING(SETTING_KEY_SERVO_PAN_MAX_DEGREE, "Max Degree", SETTING_FLAG_VALUE, FOLDER_ID_PAN, 180, 360, DEFAULT_SERVO_MAX_DEGREE),
    U16_SETTING(SETTING_KEY_SERVO_PAN_MIN_DEGREE, "Min Degree", SETTING_FLAG_VALUE, FOLDER_ID_PAN, 0, 360, DEFAULT_SERVO_MIN_DEGREE),
    ...
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_VOLTAGE_SCALE, "V. Scale", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 5000, 15000, BATTEYR_PARTIAL_PRESSURE_VALUE * 100, 11),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_MAX_VOLTAGE, "Max V.", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 740, 1680, DEFAULT_BATTERY_MAX_VOLTAGE * 100, 12),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_MIN_VOLTAGE, "Min V.", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 600, 1110, DEFAULT_BATTERY_MIN_VOLTAGE * 100, 13),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_CENTER_VOLTAGE, "Center V.", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 600, 1680, DEFAULT_BATTERY_CENTER_VOLTAGE * 100, 14),
#if defined(USE_SCREEN)
