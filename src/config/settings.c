...
static const setting_t settings[] = {
    ...
    BOOL_SETTING(SETTING_KEY_TRACKER_ADVANCED_POS_ENABLE, "Enable", SETTING_FLAG_NAME_MAP, FOLDER_ID_ADVANCED_POS, true),
    ...
    BOOL_SETTING(SETTING_KEY_WIFI_ENABLE, "Enable", SETTING_FLAG_NAME_MAP, FOLDER_ID_WIFI, true),
