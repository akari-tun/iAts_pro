...
static const setting_t settings[] = {
    ...
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_VOLTAGE_SCALE, "V. Scale", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 5000, 15000, BATTERY_PARTIAL_PRESSURE_VALUE * 100, 11),
