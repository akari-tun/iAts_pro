...
static const setting_t settings[] = {
    ...
    U16_SETTING(SETTING_KEY_TRACKER_MONITOR_BATTERY_VOLTAGE, "Voltage", SETTING_FLAG_EPHEMERAL | SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 0, 2000, 0),
