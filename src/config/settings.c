...
static const setting_t settings[] = {
    ...
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_TILT_MAX_PLUSEWIDTH, "Max PWM", SETTING_FLAG_VALUE, FOLDER_ID_TILT, 0, 3000, DEFAULT_SERVO_MAX_PLUSEWIDTH, 2),
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_TILT_MIN_PLUSEWIDTH, "Min PWM", SETTING_FLAG_VALUE, FOLDER_ID_TILT, 0, 3000, DEFAULT_SERVO_MIN_PLUSEWIDTH, 3),
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_TILT_MAX_DEGREE, "Max Degree", SETTING_FLAG_VALUE, FOLDER_ID_TILT, 0, 360, DEFAULT_SERVO_MAX_DEGREE, 4),
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_TILT_MIN_DEGREE, "Min Degree", SETTING_FLAG_VALUE, FOLDER_ID_TILT, 0, 360, DEFAULT_SERVO_MIN_DEGREE, 5),
    ...
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_PAN_MAX_PLUSEWIDTH, "Max PWM", SETTING_FLAG_VALUE, FOLDER_ID_PAN, 0, 3000, DEFAULT_SERVO_MAX_PLUSEWIDTH, 6),
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_PAN_MIN_PLUSEWIDTH, "Min PWM", SETTING_FLAG_VALUE, FOLDER_ID_PAN, 0, 3000, DEFAULT_SERVO_MIN_PLUSEWIDTH, 7),
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_PAN_MAX_DEGREE, "Max Degree", SETTING_FLAG_VALUE, FOLDER_ID_PAN, 0, 360, DEFAULT_SERVO_MAX_DEGREE, 8),
    U16_HAS_TMP_SETTING(SETTING_KEY_SERVO_PAN_MIN_DEGREE, "Min Degree", SETTING_FLAG_VALUE, FOLDER_ID_PAN, 0, 360, DEFAULT_SERVO_MIN_DEGREE, 9),
    ...
    FOLDER(SETTING_KEY_BATTERY, "Battery", FOLDER_ID_BATTERY, FOLDER_ID_ROOT, NULL),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_VOLTAGE_SCALE, "V. Scale", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 5000, 15000, BATTEYR_PARTIAL_PRESSURE_VALUE * 100, 10),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_MAX_VOLTAGE, "Max V.", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 740, 1680, DEFAULT_BATTERY_MAX_VOLTAGE * 100, 11),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_MIN_VOLTAGE, "Min V.", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 600, 900, DEFAULT_BATTERY_MIN_VOLTAGE * 100, 12),
    U16_HAS_TMP_SETTING(SETTING_KEY_BATTERY_CENTER_VOLTAGE, "Center V.", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE, FOLDER_ID_BATTERY, 600, 1680, DEFAULT_BATTERY_CENTER_VOLTAGE * 100, 13),
#if defined(USE_SCREEN)
...
static void setting_move(const setting_t *setting, int delta)
{
    ...
    if (SETTING_IS(setting, SETTING_KEY_SERVO_COURSE) ||
        ...
        SETTING_IS(setting, SETTING_KEY_SERVO_PAN_MAX_DEGREE) ||
        SETTING_IS(setting, SETTING_KEY_SERVO_PAN_MIN_DEGREE) ||
        SETTING_IS(setting, SETTING_KEY_SERVO_TILT_MAX_PLUSEWIDTH) ||
        SETTING_IS(setting, SETTING_KEY_SERVO_TILT_MIN_PLUSEWIDTH) ||
        SETTING_IS(setting, SETTING_KEY_SERVO_TILT_MAX_DEGREE) ||
        SETTING_IS(setting, SETTING_KEY_SERVO_TILT_MIN_DEGREE) ||
