...
static const setting_t settings[] = {
    ...
    FOLDER(SETTING_KEY_TRACKER_HOME, "Home", FOLDER_ID_HOME, FOLDER_ID_ROOT, NULL),
    CMD_SETTING(SETTING_KEY_TRACKER_HOME_RECOVER, "Recover Home", FOLDER_ID_HOME, 0, SETTING_CMD_STATUS_NONE),
    CMD_SETTING(SETTING_KEY_TRACKER_HOME_SET, "Set Home", FOLDER_ID_HOME, 0, SETTING_CMD_FLAG_CONFIRM),
    CMD_SETTING(SETTING_KEY_TRACKER_HOME_CLEAR, "Clear Home", FOLDER_ID_HOME, 0, SETTING_CMD_FLAG_CONFIRM),
    U8_MAP_SETTING(SETTING_KEY_TRACKER_HOME_SOURCE, "Source", 0, FOLDER_ID_HOME, home_source_table, 0),
    BOOL_YN_SETTING(SETTING_KEY_TRACKER_HOME_REAL_TIME, "Real Time", SETTING_FLAG_NAME_MAP, FOLDER_ID_HOME, false),
    I32_SETTING(SETTING_KEY_TRACKER_HOME_LON, "Longitude", SETTING_FLAG_COORDINATE | SETTING_FLAG_VALUE | SETTING_FLAG_IGNORE_CHANGE, FOLDER_ID_HOME, -1800000000, 1800000000, 0),
    I32_SETTING(SETTING_KEY_TRACKER_HOME_LAT, "Latitude", SETTING_FLAG_COORDINATE | SETTING_FLAG_VALUE | SETTING_FLAG_IGNORE_CHANGE, FOLDER_ID_HOME, -1800000000, 1800000000, 0),
    I32_SETTING(SETTING_KEY_TRACKER_HOME_ALT, "Altitude", SETTING_FLAG_FLOAT | SETTING_FLAG_VALUE | SETTING_FLAG_IGNORE_CHANGE, FOLDER_ID_HOME, -100000000, 100000000, 0),
